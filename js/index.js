  $(document).ready(function() {
      ...
      $("#btnQ2-1-6").click(function() {
          if (cnt71 == 0) {
              //$("#Q2-11Text").append('<span id="TextQ2-11"><br>其他：<input type="text" id="TQ2-1-6" style="height:1.5em;" /></span>');
              $("#Q2-1-6Text").show();
              cnt71++;
          } else {
              $("#Q2-1-6Text").hide();
      ...
      $("#btnQ2-1-7").click(function() {
          if (cnt72 == 0) {
              //$("#Q2-12Text").append('<span id="TextQ2-12"><br>最不舒服為 : <input type="text" id="TQ2-1-7" style="height:1.5em;" /></span>');
              $("#Q2-1-7Text").show();
              cnt72++;
          } else {
              $("#Q2-1-7Text").hide();
